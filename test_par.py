...
parser.add_argument('-f', '--frm-dir', type=str, default="./dataa",help="path to frame directory")
parser.add_argument('--save-dir', type=str, default='log', help="directory to save")
parser.add_argument('--save-name', type=str, default='final_summary.mp4', help="video name to save (ends with .mp4)")
