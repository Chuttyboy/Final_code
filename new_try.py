...
parser.add_argument('-d', '--dataset', type=str, default='/home/vinsent/Desktop/Final_code/dataset/multi.h5', help="path to dataset file h5")
parser.add_argument('-f', '--frm-dir', type=str, default="../data/video2",help="path to frame directory")
